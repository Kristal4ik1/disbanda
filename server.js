...
// Start server - ИЗМЕНЕНИЕ ЗДЕСЬ!
server.listen(PORT, '0.0.0.0', () => {
    console.log(`Discord Clone server running on http://0.0.0.0:${PORT}`);
    console.log(`Local access: http://localhost:${PORT}`);
    console.log(`Network access: http://192.168.194.162:${PORT}`);
    console.log(`External access: http://77.222.40.198:${PORT}`);
});